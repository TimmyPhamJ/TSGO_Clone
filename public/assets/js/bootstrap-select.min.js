						...
						if (b.multiple) {
							if (j.prop("selected", !k), b.setSelected(e, !k), d.blur(), m !== !1 || n !== !1) {
								...
								if (m && o || n && p)
									...
									var r = "function" == typeof b.options.maxOptionsText ? b.options.maxOptionsText(m, n) : b.options.maxOptionsText,
										s = r[0].replace("{n}", m),
										t = r[1].replace("{n}", n),
										u = a('<div class="notify"></div>');
									r[2] && (s = s.replace("{var}", r[2][m > 1 ? 0 : 1]), t = t.replace("{var}", r[2][n > 1 ? 0 : 1])), j.prop("selected", !1), b.$menu.append(u), m && o && (u.append(a("<div>" + s + "</div>")), h = !1, b.$element.trigger("maxReached.bs.select")), n && p && (u.append(a("<div>" + t + "</div>")), h = !1, b.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function() {
										b.setSelected(e, !1)
