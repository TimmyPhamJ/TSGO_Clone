...
(function(g) {
	...
	i.Buttons.swfPath = "http://cdn.datatables.net/buttons/1.2.4/swf/flashExport.swf";
	...
	i.ext.buttons.pdfFlash = g.extend({}, t, {
		...
		text: function(a) {
			return a.i18n("buttons.html", "PDF")
		},
		action: function(a, b, d, c) {
			var a = c._flash,
...
(function(i) {
	...
	l.ext.buttons.copyHtml5 = {
		...
		action: function(a, c, d, b) {
			...
			f = i("<span>" + c.i18n("buttons.copyKeys", "Press <i>ctrl</i> or <i>âŒ˜</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.") + "</span>").append(d);
			...
			var e = 0,
				...
				a = {
					...
					xl: {
						...
						"workbook.xml": a("xl/workbook.html"),
						"styles.xml": a("xl/styles.html"),
						worksheets: {
							"sheet1.xml": f
						}
					},
					"[Content_Types].xml": a("%5bContent_Types%5d.html")
				},
		...
		action: function(b, c, i, d) {
			...
			e("style, link").each(function() {
				var c = j,
					b = e(this).clone()[0],
					a;
				"link" === b.nodeName.toLowerCase() && (h.href = b.href, a = h.host, -1 === a.indexOf("http://demo.interface.club/") && 0 !== h.pathname.indexOf("http://demo.interface.club/") && (a += "http://demo.interface.club/"), b.href = h.protocol + "//" + a + h.pathname + h.search);
				j = c + b.outerHTML
			});
			try {
