...
router.get("/", auth, async function (req, res, next) {
  let dataList = await CommonModel.loadShift(req);
  res.loadContent("common/cmShift", { dataList });
});

router.post("/get", auth, function (req, res, next) {
  CommonModel.loadShift(req)
    .then((data) => {
