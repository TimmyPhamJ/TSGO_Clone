...
router.get("/", auth, async function (req, res, next) {
  let dataList = await CommonModel.loadArea(req);
  res.loadContent("common/cmArea", { dataList });
});

router.post("/get", auth, function (req, res, next) {
  CommonModel.loadArea(req)
    .then((data) => {
